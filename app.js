...
const I18N = {
  en: {
    ...
    nav_toei: "TOEI",
    nav_artist_phase: "PHASIA",
    status_ready: "READY TO PLAY",
    status_playing: "PLAYING NOW ⚡",
    status_paused: "PAUSED",
    badge_new_release: "✧ NEW SINGLE",
    badge_bpm_energy: "♡ PUNK ENERGY 100%",
    badge_phase_tracks: "16 SONGS ON PHASIA",
    badge_5_tracks: "5 FULL TRACKS",
    hero_title_top: "JAPANESE POST-HARDCORE & PUNK",
    hero_kanji_sub: 'BREAK THE LIMIT#2 「叫べ！夜を切り裂いて光を掴め！」',
    hero_desc: 'Wall-of-sound production driven by high-gain guitars, high-velocity dynamic skank drumming, furious double-kick pedals, and raw female rock chest vocals. Stream the 5 featured tracks from <em>NEON & FRICTION</em> directly on site, or explore ✧XE・PON♡✧\'s full 16-song catalogue on <strong>Phasia</strong>.',
    ...
    btn_prev_track: "◀ PREV",
    btn_next_track: "NEXT ▶",
    btn_stream_phase: "PHASIA ↗",
    btn_sub_open_app: "OPEN IN OFFICIAL APP ↗",
    sec2_badge: "OFFICIAL PLAYLIST",
    sec2_kanji: "PLAYLIST ♡",
    sec2_sub: "Play any of the 5 original songs directly in the site's integrated player or launch on Phasia.",
    ...
    btn_follow_phase: "FOLLOW ✧XE・PON♡✧ ON PHASIA (16 SONGS)",
    disco_badge: "⚡ COMPLETE DISCOGRAPHY // PHASIA",
    disco_title: "ALL 16 SONGS STREAMING ON PHASIA",
    disco_desc: 'Beyond the 5 featured tracks on <em>NEON & FRICTION</em>, stream ✧XE・PON♡✧\'s full 16-song catalogue of Japanese post-hardcore, alternative rock, and melodic punk directly on the official Phasia platform.',
    btn_explore_16: "STREAM ALL 16 SONGS ON PHASIA",
  ...
  ja: {
    ...
    badge_phase_tracks: "PHASIAで全16曲配信中",
    badge_5_tracks: "全5曲完全収録",
    hero_title_top: "超音速ジャパニーズ・ポストハードコア＆パンク",
    hero_kanji_sub: "BREAK THE LIMIT#2 「叫べ！夜を切り裂いて光を掴め！」",
    hero_desc: "ハイゲインギターが生み出す音の壁、超高速スカンクビート、怒涛のツーバス、そして感情と摩擦に満ちた女性ロックボーカルの生々しい叫び。『NEON & FRICTION』収録の厳選5曲をサイト内で直接試聴、またはPhasiaで✧XE・PON♡✧の全16曲カタログをストリーミング。",
    btn_play_single: "新曲を再生",
    btn_view_playlist: "全5曲を見る",
    btn_lyrics_notes: "全曲フル歌詞 & ノート",
    btn_sub_production: "全5曲 制作ディレクション",
    stat_members: "メンバー",
    stat_phase_songs: "PHASIA配信",
    stat_tracks: "サイト再生",
    stat_toei: "東映着信",
    ...
    btn_follow_phase: "PHASIAで全16曲を聴く ↗",
    disco_badge: "⚡ 完全ディスコグラフィ // PHASIA",
    disco_title: "PHASIAにて全16曲配信中",
    disco_desc: "『NEON & FRICTION』の5曲にとどまらず、公式Phasiaプラットフォームでは✧XE・PON♡✧の全16曲におよぶジャパニーズ・ポストハードコア、オルタナティブロック、メロディックパンクをストリーミング配信中。",
    btn_explore_16: "PHASIAで全16曲を聴く",
    cap_akiba: "秋葉原GIGO ✧",
    cap_street: "渋谷の路地裏 ♡",
    cap_chrome: "セッション ☆",
